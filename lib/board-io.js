 ...
 */
BoardIO.prototype.sendI2CConfig=function(delay) {
  log("BoardIO", "sendI2CConfig with delay", delay);
};
 ...
 */
BoardIO.prototype.sendI2CWriteRequest = function(slaveAddress, bytes) {
  log("BoardIO", "sendI2CWriteRequest to slave address", slaveAddress, "with bytes", bytes);
};
...
BoardIO.prototype.sendI2CReadRequest = function(slaveAddress, numBytes, callback) {
  log("BoardIO", "sendI2CReadRequest of", numBytes, "bytes from slave address", slaveAddress);
};
